    ...
    <div class="fullScreen">
        <el-tooltip effect="dark" :content="isFullscreen ? '取消全屏' : '全屏'" placement="bottom">
            <el-icon @click="toggle">
                <svg t="1705636427194" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="2721" width="200" height="200" v-if="!isFullscreen">
                    <path
                ...
                <svg t="1705637215261" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="5476" width="200" height="200" v-else>
                    <path
...
html[class='dark'] .fullScreen:hover {
